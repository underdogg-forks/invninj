...
<div class="col-lg-12">
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-address" role="tabpanel" aria-labelledby="pills-address-tab">
            ...
            <div class="row">
                <div class="col-lg-6">
                    @include('customer.partial.customer_location', ['location' => $customer->primary_billing_location->first(), 'address' => 'Billing'])
                </div>
                <div class="col-lg-6">
                    @include('customer.partial.customer_location', ['location' => $customer->primary_billing_location->first(), 'address' => 'Shipping'])
                </div>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
            @foreach($customer->contacts as $contact)
                @include('customer.partial.contact_details', ['contact' => $contact])
            @endforeach
        </div>
        ...
        <div class="tab-pane fade" id="pills-settings" role="tabpanel" aria-labelledby="pills-settings-tab">
            ...
            @include('customer.partial.customer_settings', $customer)
